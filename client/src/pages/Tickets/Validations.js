...
const customerPattern = yup.string().required('Obligatorio').max(15, 'Max. 15 letras').trim().matches(/[A-z]/, {
    message: 'Solo letras'
})

const customerMother = yup.string().required('Obligatorio').max(15, 'Max. 15 letras').trim().matches(/[A-z]/, {
    message: 'Solo letras'
})
