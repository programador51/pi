            ...
            <div className="form-group row mt-5">
              ...
              <div className="col-4">
                <Text
                  ...
                  name='averageTicket'
                  placeholder='No editable'
                  defaultValue={cash.statics.ticket.average}
                  readOnly={true}
                />
              </div>
            </div>
            ...
            <div className="form-group row mt-5">
              ...
              <div className="col-4">
                <Text
                  ...
                  placeholder='No editable'
                  defaultValue={cash.statics.rotation.average}
                  readOnly={true}
                />
              </div>
            </div>
            ...
            <div className="form-group row mt-5">
              ...
              <div className="col-4">
                <Text
                  ...
                  name='suministerDays'
                  placeholder='No editable'
                  defaultValue={cash.statics?.suministerDay?.average}
                  readOnly={true}
                />
              </div>
            </div>
            ...
            <div className="form-group row mt-5">
              ...
              <div className="col-4">
                <Text
                  ...
                  placeholder='No editable'
                  readOnly={true}
                  defaultValue={cash.statics?.suministerWeek?.average}
                />
              </div>
            </div>
          </form> : null}
